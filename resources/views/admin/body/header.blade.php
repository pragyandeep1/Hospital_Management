<nav class="navbar">
              ...
              <div class="input-group-text">
                ...
                <div class="row g-0 p-1">
                  ...
                  <div class="col-3 text-center">
                    <a href="{{route('admin.profile')}}" class="dropdown-item d-flex flex-column align-items-center justify-content-center wd-70 ht-70"><i data-feather="mail" class="icon-lg mb-1"></i><p class="tx-12">Email</p></a>
                  </div>
                  <div class="col-3 text-center">
